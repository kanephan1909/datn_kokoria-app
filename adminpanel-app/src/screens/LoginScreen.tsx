  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data) => {
      if (data.success && data.data?.user) {
        ...
        // Navigation sẽ tự động chuyển sang Main vì isAuthenticated = true
      }
    },
    onError: (error: any) => {
      const errorMessage =
    ...
    >
      ...
      >
        <View className="items-center mb-10">
          ...
          <Text className="text-3xl font-bold text-gray-900 mb-2">Kokoria Admin</Text>
          <Text className="text-gray-600 text-center text-base">Đăng nhập để quản lý hệ thống</Text>
        </View>
